  ...
  return (
    <div className='bg-[#cbd5e1] flex lg:flex-row justify-around items-center lg:h-[34rem] lg:w-screen 2xs:w-[30rem] 2xs:flex-col 2xs:h-[46rem]'>
      <motion.div
        ...
        <p className='xs:w-[40vw] 2xs:w-[90vw]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quibusdam fugit fuga illum aut delectus non deserunt eligendi. Est, vitae rerum?</p>
