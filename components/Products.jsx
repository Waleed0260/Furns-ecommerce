...
const Products = ({post, category, trending}) => {
  ...
  return (
    <>
      <div className="flex lg:justify-center md:items-center flex-col gap-5 md:mx-8 2xs:justify-center 2xs:items-center 2xs:mt-14 2xs:mr-[-30px]">
        ...
        <div className="flex flex-row xs:gap-10 p-5 2xs:gap-2">
